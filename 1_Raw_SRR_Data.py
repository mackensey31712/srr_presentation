...
with col2:
    ...
    agg_hour_on_it = df.groupby('Hour_Created')[['TimeTo: On It Sec']].mean().reset_index()
...
with col1:
    pivot_table = df.pivot_table(index='Hour_Created', columns='Case Reason', values='Service', aggfunc='count', fill_value=0)
